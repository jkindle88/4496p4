...
class Transform
{
 public:
  ...
  virtual ~Transform() {}
  virtual Mat4d GetTransform(bool b){Mat4d m=vl_zero;return m;} // return a 4x4 affine transformation evaluated at the current dof
  ...
  int mIndex;
  virtual Mat4d GetDeriv(int dof, bool b){ Mat4d m=vl_zero; return m;} // TODO: implement this function for each subclass
};
